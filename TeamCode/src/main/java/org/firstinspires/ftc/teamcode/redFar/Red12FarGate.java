...
@Autonomous(name = "Red12FarGate", group = "Autonomous")
@Configurable
public class Red12FarGate extends OpMode {
    ...
    public void init() {
        ...
        pickup1Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(84.779, 43.9288),
                                new Pose(120.5466, 58.3168, Math.toRadians(0))
                        )
                )
        ...
        gatePath = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(120.5466, 58.3168, Math.toRadians(0)),
                                new Pose(125.1288, 62.3703, Math.toRadians(0))
                        )
                )
        ...
        shoot1Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(125.1288, 62.3703, Math.toRadians(0)),
                                new Pose(104.197,68.565),
                                new Pose(90.30, 78.86, Math.toRadians(0))
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
        ...
        pickup2Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(90.30, 78.86, Math.toRadians(0)),
                                new Pose(99.53, 84.30),
                                new Pose(118.53, 84.58, Math.toRadians(0))
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
...
//                                new Pose(83.4021, 87.15887),
                                new Pose(93.16, 89.91, Math.toRadians(0))
        ...
        pickup3Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(93.16, 89.91, Math.toRadians(0)),
                                new Pose(85.02, 30.55),
                                new Pose(122.34, 35.44, Math.toRadians(0))
        ...
        shoot3Path = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(122.34, 35.44, Math.toRadians(0)),
                                new Pose(88.66, 82.63, Math.toRadians(90))
        ...
        leavePath = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(88.66, 82.63, Math.toRadians(90)),
                                new Pose(118.83, 70.12, Math.toRadians(90))
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(90))
                .build();
