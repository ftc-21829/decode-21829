...
public class Red15CloseAuto extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(111.348, 135.541, Math.toRadians(90)));
        pathState = 0;
        ...
        leavePath = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(111.348, 135.541, Math.toRadians(90)),
//
                                new Pose(119.3345, 96.0755, Math.toRadians(90))
                        )
                )
