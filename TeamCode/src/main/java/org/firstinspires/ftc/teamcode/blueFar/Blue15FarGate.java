...
@Autonomous(name = "Blue15FarGate", group = "Autonomous")
@Configurable
public class Blue15FarGate extends OpMode {
    ...
    public void init() {
        ...
        shoot1Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(20.096, 35.672, Math.toRadians(180)),
                                new Pose(54.1,52.514),
                                new Pose(55.344, 73.464, Math.toRadians(180))
                        )
                )
        ...
        gatePath = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(22.359, 55.263, Math.toRadians(180)),
                                new Pose(12.101, 62.929, Math.toRadians(180))
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
                .build();
...
//                                new Pose(83.4021, 87.15887),
                                new Pose(54.969, 78.073, Math.toRadians(180))
        ...
        pickup3Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(54.969, 78.073, Math.toRadians(180)),
                                new Pose(36.423, 85.547),
                                new Pose(20.938, 84.202, Math.toRadians(180))
        ...
        shoot3Path = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(20.938, 84.202, Math.toRadians(180)),
                                new Pose(55.112, 78.430, Math.toRadians(180))
        ...
        pickup4Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(55.112, 78.430, Math.toRadians(180)),
                                new Pose(18.036, 48.396),
                                new Pose(10.667, 14.711, Math.toRadians(90))
        ...
        shoot4Path = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(10.667, 14.711, Math.toRadians(90)),
                                new Pose(55.507, 12.185, Math.toRadians(90))
        ...
        leavePath = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(55.507, 12.185, Math.toRadians(90)),
                                new Pose(53, 20, Math.toRadians(90))
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(90))
                .build();
