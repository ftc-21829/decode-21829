    ...
    public void init() {
        ...
        gatePath = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(53.704, 85.595, Math.toRadians(180)),
                                new Pose(40.489, 66.231),
                                new Pose(12.865, 60.336, Math.toRadians(146))
                        )
                )
    ...
    public void autonomousUpdate() {
        switch (pathState) {
            ...
            case 6:
                ...
                if (!follower.isBusy() && actionTimer.getElapsedTimeSeconds() > 5.5) {
