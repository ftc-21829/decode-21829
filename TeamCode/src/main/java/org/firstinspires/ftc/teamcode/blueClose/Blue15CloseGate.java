...
@Autonomous(name = "Blue15CloseGate", group = "Autonomous")
@Configurable
public class Blue15CloseGate extends OpMode {
    ...
    public void init() {
        ...
        gatePath = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(26.37, 86.124, Math.toRadians(180)),
                                new Pose(38.381574225122364, 80.56118433931492),
                                new Pose(16.309298531810772, 75.62495921696577, Math.toRadians(180))
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
