...
@Autonomous(name = "Red12Far", group = "Autonomous")
@Configurable
public class Red12FarAuto extends OpMode {
    ...
    public void init() {
        ...
        pickup2Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(88.656, 73.464, Math.toRadians(0)),
                                new Pose(96.04073, 56.4977),
                                new Pose(121.691, 55.263, Math.toRadians(0))
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
...
//                                new Pose(83.4021, 87.15887),
                                new Pose(87.656, 73.5351, Math.toRadians(0))
        ...
        pickup3Path = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(87.656, 73.5351, Math.toRadians(0)),
                                new Pose(90.8247, 88.1696),
                                new Pose(118.53, 85.524, Math.toRadians(0))
        ...
        shoot3Path = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(118.53, 85.524, Math.toRadians(0)),
                                new Pose(95.3965, 84.1419, Math.toRadians(0))
        ...
        leavePath = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(95.3965, 84.1419, Math.toRadians(0)),
                                new Pose(115.8761, 70.6786, Math.toRadians(90))
                        )
                )
